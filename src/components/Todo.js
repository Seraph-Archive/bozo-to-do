...
export default function Todo(props) {
    ...
    const editingTemplate = (
        <form className="stack-small" onSubmit={handleSubmit}>
            ...
            <div className="btn-group">
                <button type="button" className="btn todo-cancel" onClick={() => setEditing(false)}>Cancel
    ...
    const viewTemplate = (
        <div className="stack-small">
            ...
            <div className="btn=group">
                <button type="button" className="btn" onClick={() => setEditing(true)} ref={editButtonRef}>Edit 
